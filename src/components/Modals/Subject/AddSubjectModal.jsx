...
export default function AddSubjectModal({setShowAddSubjectModal,showAddSubjectModal,setSubjects}){
    ...
    const handleDescription = (e) => {
     if(e.target.value.length <= 70) setSubject({...subject,shortDescription:e.target.value});
    }
   
    const AddSubject = async() => {
        setLoading(true);
      await axios.post(`${API_BACKEND_URL}/admin/addSubject`,subject,{withCredentials:true})
        .then((response)=>{
             ...
             <div className="Modal_body mt-5">
                <div className="flex flex-col mb-3">
                 ...
                 <div className="flex flex-col my-2">
                    ...
                    <textarea value={subject.shortDescription} type="text" name="" id="" placeholder="Subject Description" className="border border-[#ebebeb] py-1.5 pl-1.5  rounded-md" onChange={(e)=>{handleDescription(e)}} maxLength={70}/>
                ...
                <div className="flex gap-3">
                 <div className="flex flex-col my-2">
                    ...
                    <input type="text" value={subject.code} name="" id="" placeholder="eg.,CS101" className="border border-[#ebebeb] py-1.5 pl-1.5 rounded-md" onChange={(e)=>{setSubject({...subject,code:e.target.value})}} maxLength={7}/>
                </div>
