import { CircleX, Clock, Cross, Delete, Edit, Save, Settings, Timer, User, Verified, Watch, X } from "lucide-react";
...
export default function Profile() {
  ...
  useEffect(()=>{
   ...
   axios.get(`${API_BACKEND_URL}/notes/myNotes?userId=${authContext.AuthenticatedUser.id}`,{withCredentials:true})
   .then((response)=>{
  ...
  useEffect(()=>{
    console.log(tempAuthenticatedUser)
